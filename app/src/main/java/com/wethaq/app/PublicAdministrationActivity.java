...
public final class PublicAdministrationActivity extends Activity {
    ...
    private TextView card(String s,boolean important){TextView t=text(s,important?18:16,Color.WHITE);GradientDrawable d=new GradientDrawable();d.setColor(important?Color.rgb(12,30,45):Color.rgb(10,24,35));d.setCornerRadius(dp(16));d.setStroke(dp(1),important?Color.rgb(229,193,71):Color.rgb(70,90,100));t.setBackground(d);LinearLayout.LayoutParams p=new LinearLayout.LayoutParams(-1,-2);p.bottomMargin=dp(10);t.setLayoutParams(p);return t;}
    private Button button(String s){Button b=new Button(this);b.setText(s);b.setTextColor(Color.WHITE);b.setTextSize(17);b.setAllCaps(false);b.setTypeface(Typeface.DEFAULT,Typeface.BOLD);b.setBackgroundResource(R.drawable.bg_wethaq_button);b.setMinHeight(dp(62));return b;}
