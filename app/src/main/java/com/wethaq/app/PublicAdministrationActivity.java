...
public final class PublicAdministrationActivity extends Activity {
    ...
    private TextView card(String s,boolean important){TextView t=text(s,important?18:16,Color.WHITE);GradientDrawable d=new GradientDrawable();d.setColor(important?Color.rgb(9,62,59):Color.rgb(8,39,46));d.setCornerRadius(dp(16));d.setStroke(dp(1),important?Color.rgb(42,214,162):Color.rgb(36,91,99));t.setBackground(d);LinearLayout.LayoutParams p=new LinearLayout.LayoutParams(-1,-2);p.bottomMargin=dp(10);t.setLayoutParams(p);return t;}
    private Button button(String s){Button b=new Button(this);b.setText(s);b.setTextColor(Color.WHITE);b.setTextSize(17);b.setAllCaps(false);b.setTypeface(Typeface.DEFAULT,Typeface.BOLD);GradientDrawable d=new GradientDrawable();d.setColor(Color.rgb(8,48,52));d.setCornerRadius(dp(14));d.setStroke(dp(1),Color.rgb(42,214,162));b.setBackground(d);b.setMinHeight(dp(62));return b;}
