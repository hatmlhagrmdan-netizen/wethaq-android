...
public final class PremiumActivity extends Activity {
    ...
    private void show(){
        ...
        Button chats=button("💬  فتح المحادثات");Button contacts=button("👥  جهات الاتصال");Button search=button("🔎  البحث عن مستخدم");Button settings=button("⚙️  الإعدادات");
        ...
        chats.setOnClickListener(v->openMain());contacts.setOnClickListener(v->openMain());search.setOnClickListener(v->openMain());settings.setOnClickListener(v->settings());
    }
