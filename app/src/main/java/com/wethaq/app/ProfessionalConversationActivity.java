...
public final class ProfessionalConversationActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle b){super.onCreate(b);getWindow().setStatusBarColor(Color.rgb(5,5,7));getWindow().setNavigationBarColor(Color.rgb(5,5,7));build();}
    private void build(){
