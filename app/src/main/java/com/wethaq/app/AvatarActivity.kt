...
class AvatarActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val choose = Button(this).apply { text = "اختيار صورة"; isAllCaps = false; setOnClickListener { pick() } }
        val remove = Button(this).apply { text = "حذف الصورة"; isAllCaps = false; setOnClickListener { prefs.edit().remove("avatar_uri").apply(); image.setImageResource(android.R.drawable.ic_menu_gallery); Toast.makeText(this@AvatarActivity, "تم حذف الصورة", Toast.LENGTH_SHORT).show() } }
        val back = Button(this).apply { text = "رجوع"; isAllCaps = false; setOnClickListener { finish() } }
