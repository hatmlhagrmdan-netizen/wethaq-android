...
old='private void send(){String text=input==null?"":input.getText().toString().trim();if(text.isEmpty()||activeId==null)return;'
new='''private void send(){
