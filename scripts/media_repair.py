...
# Normalize media state fields so repeated CI repair passes never create duplicate members.
...
# Image selection becomes a real draft instead of sending immediately.
...
# Keep exactly one preview method.
...
# Audio recording is retained as a draft until the main Send button is pressed.
