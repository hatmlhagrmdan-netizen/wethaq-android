...
express.application.get=function(path,...handlers){
  ...
  if(path==='/api/admin/audit-log'){
    ...
    return originalGet.call(this,path,requireAdmin,(req,res,next)=>{if(req.__wethaqHardeningRole!=='founder')return res.status(403).json({error:'founder_only'});next();},endpointHandler);
  }
